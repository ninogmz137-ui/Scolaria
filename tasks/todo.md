...
- [ ] **À décider (constat Redmi, 26 sept)** : « Voir le fichier » d'un PDF ouvre l'URL signée dans Chrome, qui TÉLÉCHARGE le document dans les Téléchargements publics du téléphone (copie hors de l'app, visible par les autres applis). Piste : visionneuse dans l'app ou fichier temporaire privé + partage explicite.
